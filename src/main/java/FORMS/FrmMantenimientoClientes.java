...
public class FrmMantenimientoClientes extends javax.swing.JInternalFrame {
    ...
    private void initListeners() {
        ...
        tblListaCliente.getSelectionModel().addListSelectionListener(e -> {
    ...
    private void configurarTabla() {
        modeloTabla = new DefaultTableModel(
            new String[]{"ID", "DNI", "Nombres", "Apellidos", "Teléfono", "Correo", "Dirección", "Estado"}, 0
        ) {
            @Override
        ...
        tblListaCliente.setModel(modeloTabla);
    }
    ...
    private void buscarCliente() {
        ...
        ClienteClass cli = clienteDAO.buscarPorDocumento(dni);
        modeloTabla.setRowCount(0);
        if (cli != null) {
            modeloTabla.addRow(new Object[]{
                cli.getIdCliente(), cli.getDocumento(), cli.getNombreCliente(),
                cli.getApellidos(), cli.getTelefono(), cli.getCorreo(),
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MANTENIEMIENTO DE CLIENTES");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(72, 72, 72)
                        .addComponent(txtBuscarDni, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(56, 56, 56)
